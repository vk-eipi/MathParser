...
int Operation::getArity(){return arity;}
Number Operation::getIdentity(){return identity;}
...
bool Addition::isAddable(const ExpressionNode& term1, const ExpressionNode& term2)
{
...
ExpressionNode Multiplication::simplify(ExpressionNode& left, ExpressionNode& right)
{
	// unimplemented
